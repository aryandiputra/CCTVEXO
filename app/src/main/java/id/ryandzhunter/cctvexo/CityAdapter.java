...
public class CityAdapter extends BaseAdapter {
    ...
    public static final String TAG = ListCCTVActivity.class.getName();

    private LayoutInflater inflater;

    private List<Busway> cities = null;

    public CityAdapter(Context context) {
        inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }

    public void setData(ArrayList<Busway> details) {
        this.cities = details;
    }
    ...
    public View getView(int position, View currentView, ViewGroup parent) {
        ...
        Busway city = cities.get(position);

        if (city != null) {
            ((TextView) currentView.findViewById(R.id.name)).setText(city.getArea());
        }
